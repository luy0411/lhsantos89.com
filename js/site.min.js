    ...
    function(e) {
        ...
        e(window).resize(function() {
            ...
            e(window).scroll(function() {
                ...
                return o.removeClass("error"), i = !1, "" === s.val() && (i = !0, s.parent().addClass("error")), "" !== a.val() && x(a.val()) || (i = !0, a.parent().addClass("error")), "" === r.val() && (i = !0, r.parent().addClass("error")), i || e.post("http://formspree.io/lhsantos89@gmail.com", n.serialize(), function(e) {
                    l.html(e)
                }), !1
            }), h(), u()
        })
